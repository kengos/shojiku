...
onMounted(async () => {
  try {
    ...
    busy.value = "";
    diagnostics.value = [{ severity: "error", code: "boot_failed", message: String(e) }];
  }
});
</script>
...
<template>
  <div class="live-block">
    ...
    <div class="live-bar">
      ...
      <button v-if="!jp" class="live-btn" :disabled="busy !== ''" @click="toJapanese">日本語フォントを読み込む (9 MB)</button>
