...
> **GitHub Actions is currently disabled** on this repository (private,
> Actions billing). Red or missing checks on a PR are that, not your
> change — the local `make` gates are the merge bar until it is
> re-enabled.
