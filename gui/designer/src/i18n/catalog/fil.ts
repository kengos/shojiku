...
export const fil: LanguageCatalog = {
  ...
  chrome: {
    ...
    'pdf.title': 'I-download bilang PDF',
    ...
    'insert.pageNumber.bandOnly': 'direkta sa header o footer lang mailalagay',
    'insert.pageBreak': 'Break ng pahina',
    'insert.pageBreak.flowOnly': 'direkta sa katawang flow lang mailalagay',
    ...
    'insert.line': 'Linya',
    'insert.ellipse': 'Elipse',
    'insert.checkbox': 'Checkbox',
    'panel.mark.ellipseState': 'Kailan iginuguhit',
    'panel.mark.checkboxState': 'Tsek',
    'panel.mark.state.always': 'Palagi',
    'panel.mark.state.blank': 'Blangko',
    'panel.mark.state.ticked': 'May tsek',
    'panel.mark.state.bound': 'Mula sa datos',
    'panel.mark.field': 'Field ng datos',
    'panel.mark.value': 'Iginuguhit kapag ang halaga ay',
    'panel.mark.tickValue': 'Tsek kapag ang halaga ay',
    'panel.mark.conflict':
      'May tsek AT may datos ang item na ito. Mananaig ang datos; alisin ang isa.',
    'panel.mark.documentScope': 'Nagbabasa ng field sa itaas na antas, hindi ng hilerang ito.',
    'panel.field.shapeStroke': 'Balangkas',
    'panel.shape.widthFromStyle': 'Ang kapal ay mula sa estilong “{name}”.',
    'panel.ellipse.circle': 'Bilugan ang isang item',
    ...
    'insert.paste': 'Mag-paste ng talahanayan…',
    ...
    'insert.block.neverDraws': 'May item sa loob na hindi kailanman iginuguhit',
    ...
    'iterable.variant.flowOnly':
      'Ang Mga card at Grid ay para sa katawang flow. Hindi flow ang katawan ng dokumentong ito.',
    ...
    'canvas.link.description': 'Naka-link sa {url}',
    ...
    'panel.rowConditions.adds': 'Nagdaragdag',
    'panel.rowConditions.addsNothing': 'Walang idinaragdag na sariling format',
    'panel.rowConditions.addsStyleNames': 'Named style ×{count}',
    'panel.rowConditions.notBold': 'Hindi bold',
    'panel.rowConditions.addsOther': 'Iba pa ×{count}',
    ...
    'panel.frame.title.cell': 'Frame ng cell',
    'panel.frame.title.card': 'Frame ng card',
    'panel.frame.title.columnCell': 'Frame ng cell ng column',
    'panel.frame.every.cell': 'Ginagamit ng bawat cell ng grid ang frame na ito.',
    'panel.frame.every.card': 'Ginagamit ng bawat card ang frame na ito.',
    'panel.frame.every.columnCell':
    ...
    'panel.frame.edit.cell': 'I-edit ang frame ng cell',
    'panel.frame.edit.card': 'I-edit ang frame ng card',
    'panel.frame.edit.columnCell': 'I-edit ang frame ng cell',
    ...
    'panel.section.repeatGrid': 'Grid sa bawat pahina',
    'panel.repeat.columns': 'Mga column',
    'panel.repeat.rows': 'Mga row',
    'panel.repeat.columnGap': 'Pagitan ng column',
    'panel.repeat.rowGap': 'Pagitan ng row',
    'panel.repeat.direction': 'Pagkakasunod ng pagpuno',
    'panel.repeat.direction.row': 'Punan pahalang',
    'panel.repeat.direction.column': 'Punan pababa',
    'panel.repeat.newPage': 'Magsimula sa bagong pahina',
    'panel.repeat.cutMarks': 'Gumuhit ng mga marka ng pagputol',
    'panel.repeat.hint':
      'Isang cell para sa bawat row ng data, column × row sa isang pahina (hanggang 64). Ang ipinapakita ng cell ay ang mga item na nakalista sa ilalim ng grid na ito sa Istruktura.',
    ...
    'styleCapture.createTitle': 'I-save ang pormat bilang estilo',
    'styleCapture.updateTitle': 'I-update ang "{name}" para tumugma sa pinili',
