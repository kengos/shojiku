...
export const en: LanguageCatalog = {
  ...
  chrome: {
    ...
    'insert.pageNumber.bandOnly': 'only directly in a header or footer',
    'insert.pageBreak': 'Page break',
    'insert.pageBreak.flowOnly': 'only directly in a flow body',
    ...
    'iterable.variant.grid': 'Grid',
    'iterable.variant.list': 'List',
    'iterable.variant.flowOnly':
      'Cards and Grid need a flow body. This document’s body is not a flow.',
    ...
    'panel.frame.title.cell': 'Cell frame',
    'panel.frame.title.card': 'Card frame',
    'panel.frame.title.columnCell': 'Column cell frame',
    'panel.frame.every.cell': 'Every cell of the grid uses this frame.',
    'panel.frame.every.card': 'Every card uses this frame.',
    ...
    'panel.frame.edit.cell': 'Edit the cell frame',
    'panel.frame.edit.card': 'Edit the card frame',
    'panel.frame.edit.columnCell': 'Edit the cell frame',
    ...
    'panel.section.repeatGrid': 'Grid on each page',
    'panel.repeat.columns': 'Columns',
    'panel.repeat.rows': 'Rows',
    'panel.repeat.columnGap': 'Column gap',
    'panel.repeat.rowGap': 'Row gap',
    'panel.repeat.direction': 'Fill order',
    'panel.repeat.direction.row': 'Fill across',
    'panel.repeat.direction.column': 'Fill down',
    'panel.repeat.newPage': 'Start on a new page',
    'panel.repeat.cutMarks': 'Draw cut marks',
    'panel.repeat.hint':
      'One cell per data row, columns × rows to a page (64 at most). What a cell shows is the items listed under this grid in Structure.',
    ...
    'tree.type.cell_frame': 'Cell',
    'tree.type.card_frame': 'Card',
    'tree.type.item': 'Item',
